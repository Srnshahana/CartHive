  ...
  return (
    <article className="category-card-screenshot" style={{ boxShadow: '0 4px 20px -2px rgba(0, 0, 0, 0.05), 0 0 3px rgba(0,0,0,0.02)' }}>
      ...
      <div style={{ width: '100%', flex: 1, display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
        ...
        <h3 style={{ fontSize: '1.1rem', fontWeight: '700', color: '#0f172a', marginBottom: '1rem' }}>{template.name}</h3>
        ...
        <div style={{ display: 'flex', gap: '8px', marginTop: 'auto', flexWrap: 'wrap' }}>
          {!active && (
            <button
              ...
              style={{ flex: 1, minWidth: '80px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '8px', fontSize: '0.8rem', fontWeight: '600', color: '#334155', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
            >
              <Eye size={14} /> Preview
            </button>
          )}
